...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  ...
  $updateGoTo = "employeemanager.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    ...
    <form action="<?php echo $editFormAction; ?>" method="post" enctype="multipart/form-data" name="form1" onSubmit="<?php echo $ppu->getSubmitCode() ?>;return document.MM_returnValue">
      ...
      <table align="center" class="table">
        ...
        <tr valign="baseline">
          ...
          <td><a href="employeemanager.php" class="btn btn-default">Back</a> <input type="submit" class="btn btn-info" value="Update record"></td>
        </tr>
      </table>
