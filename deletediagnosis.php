...
if ((isset($_GET['patientdiagID'])) && ($_GET['patientdiagID'] != "")) {
  $deleteSQL = sprintf("DELETE FROM tbl_diagnosis_patient WHERE patientdiagID=%s",
                       GetSQLValueString($_GET['patientdiagID'], "int"));
