...
$MM_restrictGoTo = "emrmanager.php";
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <div class="media"> <a class="pull-left" href="#">
          <?php if ($row_rsUsers['photo'] != NULL) {echo "<img src=\"http://abwemr.com/employeeportal/thumbnail/$row_rsUsers[photo]\" class=\"media-object\" alt=\"user\" width=\"64\">";} else {echo "<img class=\"media-object\" src=\"images/user.jpg\" alt=\"user\" width=\"64\" height=\"64\" />";}?>
          </a>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table border="0" class="table">
          ...
          <?php do { ?>
            <tr>
              <td width="50%"><small><?php echo $row_rsTimeoff['firstname']; ?> <?php echo $row_rsTimeoff['lname']; ?></small></td>
              <td width="40%" align="right"><small><?php echo date('m/d',strtotime($row_rsTimeoff['startdate'])); ?> - <?php echo date('m/d',strtotime($row_rsTimeoff['enddate'])); ?></small></td>
              <td width="10%"><a href="deletetimeoff.php?requestID=<?php echo $row_rsTimeoff['requestID']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
         ...
         <ul class="movefile">
                 ...
                 <li><a href="docs/<?php echo $row_rsCompanyInfo['filelocation']; ?>"><?php echo $row_rsCompanyInfo['title']; ?></a></li>
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="row">
          ...
          <div class="col-md-2">
            <?php if($row_rsAdminID['accesslevel']== 3){echo "<button type=\"button\" data-toggle=\"modal\" data-target=\"#postannouncement\" class=\"btn btn-info btn-xs pull-right\">Post Announcement</button>";}?>
          </div>
        </div>
      </div>
          ...
          <tbody>
            <?php do { ?>
              <tr>
                ...
                <td align="right"><?php echo date('m/d/Y', strtotime($row_rsAnnouncements['date'])); ?> <a href="deleteannouncement.php?announcementID=<?php echo $row_rsAnnouncements['announcementID']; ?>"><span class="glyphicon glyphicon-remove"></span></a></td>
              </tr>
    ...
    <div class="panel panel-default">
      ...
      <div class="row">
        <div class="col-md-8"><h3 class="panel-title"><strong>Work Schedule</strong></h3></div>
         <div class="col-md-4">
          php if($row_rsAdminID['accesslevel']== 3){echo"
         <div class=\"btn-group pull-right\">
  <button class=\"btn btn-info btn-xs\" data-toggle=\"modal\" data-target=\"#addevent\">Add Event</button>
  <a href=\"manageevents.php\" class=\"btn btn-info btn-xs\">Manage Work Schedule</a>
</div>";}?> </div>
        </div>
      </div>
      <div class="panel-body">
