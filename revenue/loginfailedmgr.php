...
if (isset($_POST['userID'])) {
  ...
  $MM_redirectLoginFailed = "loginfailedmgr.php";
...
<body>
 <div class="container">
      ...
      <form METHOD="POST" id="loginform" class="form-signin" action="<?php echo $loginFormAction; ?>">
        <h2 class="form-signin-heading"><img src="images/logo.png" width="163" height="90"></h2>
         <div class="alert alert-danger">Your User ID or password was invalid</div>
         <h3>Management Portal Login</h3>
